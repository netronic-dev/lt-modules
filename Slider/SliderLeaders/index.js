      ...
      <div
        className={`${
          props.slidesToShow === 3
            ? style.leaders_images
            : style.leaders_images_grid
        } leaders-slider_images`}
      >
        <Slider
          asNavFor={nav1}
        ...
        >
          {props.data.map((data, index) => (
            <ImageAdder image={data.image} key={index} />
          ))}
        </Slider>
      </div>
    </div>
  ...
  return (
    <div className={style.cell}>
      ...
      <div className={style.text_block}>
        <div className={style.quote_left}>{quoteLeft}</div>
        <p className={`${style.text} zoom-animation animated-third`}>
          {props.text}
        </p>
        <div className={style.quote_right}>{quoteRight}</div>
      </div>
    </div>
  );
}
...
function ImageAdder(props) {
  return (
    <div
      className={`${style.image_block} active-image zoom-animation animated-third`}
    >
      <Image
        src={props.image}
        layout="fill"
...
const prevButton = (
  <svg width="77" height="77" viewBox="0 0 77 77" fill="none">
    ...
    <path
      d="M43 22L32.8284 32.1716C31.2663 33.7337 31.2663 36.2663 32.8284 37.8284L43 48"
      stroke="black"
      strokeWidth="2"
    />
    <defs>
...
const nextButton = (
  <svg width="77" height="77" viewBox="0 0 77 77" fill="none">
    ...
    <path
      d="M34 22L44.1716 32.1716C45.7337 33.7337 45.7337 36.2663 44.1716 37.8284L34 48"
      stroke="black"
      strokeWidth="2"
    />
    <defs>
