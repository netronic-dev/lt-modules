      ...
      <div className={style.cell_in}>
        <div className={style.review}>
          ...
          {props.videoLink && (
            <div
              ...
              onClick={() => {
                props.onVideoOpen(props.videoLink);
              }}
            >
              <Image
                src={
                  props.videoImg ||
                  `https://i.ytimg.com/vi/${props.videoLink}/maxresdefault.jpg`
                }
        ...
        <div className={style.info}>
          ...
          <div className={style.text_block}>
            ...
            <p className={style.title}>{props.location}</p>
          </div>
        </div>
      </div>
...
const videoIcon = (
  <svg width="81" height="81" viewBox="0 0 81 81" fill="none">
    ...
    <path
      d="M48.8604 40.4151L36.2025 47.7231L36.2025 33.1071L48.8604 40.4151Z"
      fill="white"
    />
  </svg>
);
