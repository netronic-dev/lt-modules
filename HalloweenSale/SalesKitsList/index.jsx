							...
							<div className={style.buttons__wrapp}>
								...
								<span
									className={`${style.item_learn_more} ${
										inView
											? style.animation__learn_more__up
											: ''
									}`}
							...
							<div
								...
								<div className={style.content}>
									...
									<div className={style.sets__grid}>
										{props.modalsData[
											modalIndex
										].sets_info.map((item, index) => (
											<div
												className={style.set__item}
												key={index}>
									...
									<div className={style.modal__price}>
										<span
											className={
												style.modal_active_price
											}>
											{
												props.modalsData[modalIndex]
													.activePrice
											}
										</span>
										<span
											className={
												style.modal_unactive_price
											}>
											{
												props.modalsData[modalIndex]
													.unActivePrice
