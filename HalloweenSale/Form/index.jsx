        ...
        >
            ...
            <defs>
                <clipPath id="clip0_2_1171">
                    <rect width="350" height="363" rx="20" fill="white" />
                </clipPath>
            </defs>
        </svg>
    );
    ...
    return (
        <section className={style.main}>
            <div className={style.content}>
                <h2 className={style.title} id="sale">
                    {props.title}
                </h2>
                <p className={style.text} ref={ref}>
                    {props.text}
                </p>
                <InputsWName
            ...
            {inView ? (
                <>
                    <div
                        className={`${style.main_ribbon} ${
                            inView ? style.animation_ribbon_1 : ""
                        }`}
                    >
                        <div
                            className={`${style.ribbon__text} ${style.ribbon__text_1}`}
                        >
                            Halloween Special Offer
                        </div>
                        <div
                            className={` ${style.ribbon__text} ${style.ribbon__text_2}`}
                        >
                            Halloween Special Offer
                        </div>
                        <div
                            className={` ${style.ribbon__text} ${style.ribbon__text_3}`}
                        >
                            Halloween Special Offer
                        </div>
                        <div
                            className={` ${style.ribbon__text} ${style.ribbon__text_4}`}
                        >
                            Halloween Special Offer
                        </div>
                    </div>
                    <div
                        className={`${style.main_ribbon_2} ${
                            inView ? style.animation_ribbon_2 : ""
                        }`}
                    >
                        F
                        <div
                    ...
                    <div
                        className={`${style.main_ribbon_3} ${
                            inView ? style.animation_ribbon_3 : ""
                        }`}
                    >
                        <div
                            className={`${style.ribbon__text} ${style.ribbon__text_1}`}
