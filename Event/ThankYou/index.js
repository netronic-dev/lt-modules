    ...
    <section className={style.thank_you}>
      ...
      <div className={style.how_find}>
        <div className={style.text_block}>
          <h2 className={style.how_find__title}>{props.title2}</h2>
          <div className={style.when}>
            <div className={style.when__title}>
              {calendarIcon}
              {props.dateName}
            </div>
            <p className={style.when__text}>{props.date}</p>
          </div>
          <div className={style.where}>
            ...
            <p className={style.where__text}>{props.placeText}</p>
          </div>
          <div className={style.calendar}>
            <p className={style.calendar__text}>{props.calendarText}</p>
