    ...
    <section className={style.section}>
      <div className={style.how_find}>
        <div className={style.text_wrapper}>
          <h2 className={props.lt_convention ? style.title_new : style.title}>
            {props.title}
          </h2>
          <div className={style.cell_row}>
            ...
            {props.timeText ? (
              <div className={style.cell}>
                ...
                <p className={style.cell__text}>{props.timeText}</p>
              </div>
            ) : null}
            <div className={style.cell}>
              <div className={style.cell_title}>
        ...
        {props.mapImage && (
          <div
            className={`${style.map} ${props.sizesMap ? style.map_sizes : ""}`}
          >
            <img src={props.mapImage} alt="map" />
          </div>
        )}
      </div>
      {props.bg_figure && (
        <div
          className={
            props.lt_convention ? style.bg_figure_conv : style.bg_figure
          }
        >
          <Image
            src={props.bg_figure}
