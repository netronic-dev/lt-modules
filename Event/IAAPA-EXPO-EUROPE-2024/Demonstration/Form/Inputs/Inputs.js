...
export function InputCountry(props) {
  const icon = {
    error: icons.error,
    agree: icons.agree,
  };
  ...
  return (
    <div className={style.input_block_out}>
      <div className={theme[props.theme ? props.theme : "standard"]}>
        ...
        {props.anotherPlace ? (
          <AddingPlaceholder
            text={props.anotherPlace || "Country"}
            value={props.value}
          />
        ) : (
          ""
            ...
            {props.data.map((item, index) => (
              <li
                ...
                className={`${style.dropdownlist_item} ${
                  listTitle === item.name ? style.dropdownlist_item_active : ""
                }`}
                onClick={() => {
  ...
  return (
    <div className={style.input_block_out}>
      <div className={theme[props.theme ? props.theme : "standard"]}>
        ...
        />
        {props.anotherPlace ? (
          <AddingPlaceholder text={props.anotherPlace} value={props.value} />
        ) : (
          ""
        )}
        {props.noIcons ? (
