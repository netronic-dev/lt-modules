...
import mainImgTwo from "../../../../public/blog/iaapa-expo-europe-2024/mainImgTwo.webp";
    ...
    <section className={style.main}>
      <div className={style.wrapper}>
        <div className={style.block_title}>
          <div className={style.blue_bg_figure}>
            <Image
              src={props.blue_bg_figure}
              layout="fill"
              objectFit="contain"
          ...
          <h1 className={style.title}>
            <span className={style.spanTitle}>{props.spanTitle}</span> <br />
            {props.title || ""}
          </h1>
        </div>
        {props.sub_title && (
        ...
        <ul className={style.imagesList}>
          <li className={style.imageItemOne}>
            <Image src={mainImgOne} layout="fill" alt="Image-one" />
          </li>
          <li className={style.imageItemTwo}>
            <Image src={mainImgTwo} layout="fill" alt="Image-two" />
          </li>
          <li className={style.imageItemThree}>
            <Image src={mainImgThree} layout="fill" alt="Image-three" />
          </li>
        ...
        >
          <Link href={props.link} scroll={false}>
            <a className={style.button} style={{}}>
              {props.buttonText}
            </a>
          </Link>
        </div>
