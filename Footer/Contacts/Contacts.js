          ...
          <div className={style.contacts__content}>
            ...
            <div className={style.contacts__content_item}>
              ...
              <p className={`${style.contacts__link} ${style.default}`}>
                Kaupmehe tn 7-120 Tallinn Harjumaa
                10114 Republic of Estonia
              </p>
            </div>
            <div className={style.contacts__content_item}>
            ...
            <div className={`${style.contacts__content_item} ${style.short}`}>
              <p className={style.title}>Email</p>
              <a target="_blank" href="mailto:sales@lasertag.net">
                <p className={style.contacts__link_underline}>sales@lasertag.net</p>
              </a>
            </div>
            <div className={`${style.contacts__content_item} ${style.short}`}>
              <p className={style.title}>Phone</p>
              <a target="_blank" href="tel:+37258662265">
                <p className={style.contacts__link}>+372 5866 2265</p>
              </a>
            </div>
          </div>
          <div className={style.contacts__icons}>
        ...
        <div className={style.contacts_two_cards}>
          <div className={style.contacts__content}>
            ...
            <div className={style.contacts__content_item}>
              ...
              <p className={`${style.contacts__link} ${style.default}`}>
                1300E 40th Street, Houston TX 77202
              </p>
            </div>
            <div className={`${style.contacts__content_item} ${style.short}`}>
              <p className={style.title}>Email</p>
            ...
            <div className={`${style.contacts__content_item} ${style.short}`}>
              <p className={style.title}>Phone</p>
              <a target="_blank" href="tel:+16465859534">
                <p className={style.contacts__link}>+1 646 585 9534</p>
              </a>
              <a target="_blank" href="tel:+16464802917">
                <p className={style.contacts__link}>+1 646 480 2917</p>
              </a>
            </div>
          </div>
          <div className={style.contacts__icons}>
...
const skypeLogo = (
  <svg width="23" height="23" viewBox="0 0 23 23" fill="none" className={style.skype}>
    <g clipPath="url(#clip0)">
      <path d="M21.7915 12.8099C23.0354 5.69201 16.8268 -0.401077 9.82718 0.912507C4.49126 -2.35174 -1.6339 3.86967 1.63676 9.18909C0.365346 16.2905 6.5721 22.4624 13.6295 21.1149C18.9755 24.3563 25.0814 18.1266 21.7915 12.8099ZM12.0721 18.21C9.15618 18.21 6.2256 16.8827 6.24026 14.5974C6.24485 13.9081 6.75726 13.2756 7.44018 13.2756C9.1571 13.2756 9.1406 15.8377 11.8741 15.8377C13.7927 15.8377 14.4472 14.7872 14.4472 14.0557C14.4472 11.4102 6.15776 13.0318 6.15776 8.05792C6.15776 5.36476 8.3596 3.50942 11.8218 3.71201C15.1237 3.90726 17.0588 5.36476 17.2458 6.72692C17.3383 7.61701 16.7489 8.31001 15.725 8.31001C14.2327 8.31001 14.0796 6.31076 11.5083 6.31076C10.3478 6.31076 9.36885 6.79476 9.36885 7.84526C9.36885 10.0407 17.6097 8.76651 17.6097 13.5983C17.6088 16.384 15.3886 18.21 12.0721 18.21Z" fill="white" />
    </g>
    <defs>
      <clipPath id="clip0">
        <rect width="22" height="22" fill="white" transform="translate(0.719727 0.0078125)" />
      </clipPath>
    </defs>
  </svg>
