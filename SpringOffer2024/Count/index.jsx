...
const Count = (props) => {
    ...
    const targetDate = new Date("2024-04-19T00:00:00").getTime();
    ...
    const renderer = ({ days, completed }) => {
        ...
        if (completed) {
            props.setIsTimerCompleted(true);
            return <span className={style.countdown_number}>0</span>;
        } else {
            props.setIsTimerCompleted(false);
    ...
    return (
        <section className={style.main}>
            ...
            <div className={style.right_flower}>
                <Image
                    src={props.rightFlower}
                    alt="pumpkins image"
                    layout="fill"
                    objectFit="cover"
                    objectPosition="50% 0"
            ...
            <div className={style.left_flower}>
                <Image
                    src={props.leftFlower}
                    alt="pumpkins image"
                    layout="fill"
                    objectFit="cover"
                    objectPosition="50% 0"
